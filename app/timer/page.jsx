...
export default function TimerStopwatch() {
  ...
  const timerProgress =
    timerInitialTime > 0
      ? ((timerInitialTime - timerTime) / timerInitialTime) * 100
      : 0;
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
              ...
              <div className="text-center mb-8">
                <div className="text-7xl font-bold text-gray-800 mb-2 font-mono">
                  {stopwatchFormatted.hours}:{stopwatchFormatted.minutes}:
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              +{diffFormatted.minutes}:{diffFormatted.seconds}.
                              {diffFormatted.milliseconds}
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
              ...
              <div className="text-center mb-8">
                <div className="text-7xl font-bold text-gray-800 mb-4 font-mono">
                  {timerFormatted.hours}:{timerFormatted.minutes}:
                  ...
                  <div className="relative w-48 h-48 mx-auto mb-6">
                    <svg className="transform -rotate-90 w-48 h-48">
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${
                          2 * Math.PI * 88 * (1 - timerProgress / 100)
                        }`}
